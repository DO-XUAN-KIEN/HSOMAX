...
public class KingCupManager {
    ...
    public static boolean register = false;  // Trạng thái đăng ký
    public static long timeRegister = 0;     // Thời gian đăng ký

    private static KingCupManager instance;
    ...
    public static KingCupManager gI() {
        if (instance == null) {
            instance = new KingCupManager();
        }
        return instance;
    }

    public void startRegister() {
        register = true;                    // Mở đăng ký
        timeRegister = System.currentTimeMillis();  // Thiết lập thời gian đăng ký hiện tại
        // Thêm logic khác nếu cần, ví dụ như reset số lượt, cập nhật thông báo, v.v.
    }
