...
public class ItemStar {
   ...
   public static List<Option> GetOpsItemStarUpgrade(
        short clazz, short typeItem, short idItem, int tier2, List<Option> lastOps) {
        ...
        for (ItemTemplate3 tem : t) {
           ...
           for (Option o : lastOps) {
               ...
               if (o.id == 5 || o.id == 6 || (o.id >= 58 && o.id <= 60) || (o.id >= 100 && o.id <= 107)) {
    kham.add(o);
    ++countkham;
    continue;
}
            ...
            if (!next && Math.abs((lastOps.size() - countkham) - tem.getOp().size()) < 2) {
                ...
                if ((id_op_change >= 0 && id_op_change <= 4) || (id_op_change >= 7 && id_op_change <= 13) || (id_op_change >= 16 && id_op_change <= 22)) {
                    boolean clear = false;
                    for (Option o : re) {
                      if ((id_op_change >= 0 && id_op_change <= 6 && id_op_change != 5 && id_op_change != 6)
    || (id_op_change >= 7 && id_op_change <= 13)
    || (id_op_change >= 16 && id_op_change <= 22)) {
                            o.id = id_op_change;
                            break;
                        } else
                            clear = true;
  ...
  public static byte ConvertType(short typeItem) {
