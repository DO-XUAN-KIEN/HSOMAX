...
public class EffTemplate {
  ...
  public static final byte QUANG_TUYET = 64; // ID tùy chọn
  public static final byte GOI_SET = 42;
  public static final byte LOI_PHAT = 43;  //-96
  public static final byte LUA_HOA_NGUC = 53;  //-95
  public static final byte CHONG_MAT = 36; //-79
  public static final byte TE_DAI = 45;
   public static final byte BIEN_DANG = 47;
   public static final byte GIAM_SAT_THUONG = 45;
   public static final byte VO_DICH = 33;
  public static final byte ONE_HIT = 47;
