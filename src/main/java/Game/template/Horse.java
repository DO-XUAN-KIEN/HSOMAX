...
public class Horse {
    ...
    public static final byte CORGI = 23;
    public static final byte HUOU = 23;
    public static final byte CHUOT_CONG = 23;
    public static final byte GAU = 23;
    public static final byte RONG_RED = 23;
    public static final byte RONG_BLUE = 23;
    public static final byte RONG_YELLOW = 23;
