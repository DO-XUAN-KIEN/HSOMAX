...
public class Pet {
    ...
    public static String[] name_template = new String[]{"Cú", "Dơi", "Sói", "Đại Bàng", "Khỉ", "Rồng lửa", "Thỏ",
            "Phượng hoàng băng", "Zabivaka", "Bóng ma", "Dê con", "Yêu tinh", "Thiên thần", "Sao la", "Mèo", "","","","","","Rắn"};
    static short[] id_template = new short[]{2944, 2943, 2939, 3269, 3616, 4617, 4622, 4626, 4631, 4699, 4708, 4761, 4762, 4768, 4788, 4871};
