...
public class EventManager {
    ...
    public synchronized static boolean notCanRegister() {
        ...
        return Manager.hour == 15 && Manager.minute >= 14;
    }

    public static boolean check(ArrayList<PlayerRegister> list, String name) {
    ...
    public short total;
    public int rank;
    public int quant; // thêm trường này
    ...
    public PlayerRegister(String name) {
        ...
        this.total = 0;
        this.rank = -1;
        this.quant = 0; // khởi tạo
    }

    public PlayerRegister(String name, int quant) {
        this(name);
        this.quant = quant;
    }
